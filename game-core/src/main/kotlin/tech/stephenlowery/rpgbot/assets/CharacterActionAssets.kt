...
//    private val GenericAttack: CharacterAction
//        get() = CharacterAction(
...
//        )
//
//    private val GenericSelfDefend: CharacterAction
//        get() = CharacterAction(
...
//    private val Heal: CharacterAction
//        get() = CharacterAction(
...
//    private val WindupAttack: CharacterAction
//        get() = CharacterAction(
...
//    private val LongChargeUpAttack: CharacterAction
//        get() = CharacterAction(
//            effect = DelayedEffect(
//                delay = 2,
...
//    private val LifeSteal: CharacterAction
//        get() = CharacterAction(
...
//    private val AmpUp: CharacterAction
//        get() = CharacterAction(
...
//    private val Bleed: CharacterAction
//        get() = CharacterAction(
//            effect = ChainEffect(
//                DamageHealthEffect(
//                    min = 20,
...
//    private val Renew: CharacterAction
//        get() = CharacterAction(
//            effect = HealEffect(
//                min = 12,
//                max = 16,
